...
public class ServerChatConsoleReaderThread extends Thread{ //服务器聊天终端监听子线程
    private Socket socket; //定义管道变量
    private DataInputStream dis; //定义文件输入流
    private ServerChatConsole win; //定义聊天界面
    public ServerChatConsoleReaderThread(Socket socket, ServerChatConsole win){ //接收主线程信息
        this.win = win; //引入聊天界面
